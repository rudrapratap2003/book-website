...
const Sell = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fdf1e5] flex items-center justify-center px-4 py-8">
      ...
      <div className="bg-white rounded-3xl shadow-xl flex flex-col lg:flex-row overflow-hidden max-w-6xl w-full">
        {/* Left Form */}
        <div className="w-full lg:w-1/2 p-8 sm:p-10">
          <h2 className="font-gothic text-2xl sm:text-3xl font-bold text-left text-blue-950 mb-6">
